...
CREATE TABLE message_outbox (
                                ...
                                event_type VARCHAR(50) NOT NULL COMMENT '事件类型，例如 picture_update',
                                ref_id BIGINT NOT NULL COMMENT '业务主键，例如 pictureId',
                                payload TEXT COMMENT '事件附加信息（可选）',
                                status VARCHAR(20) DEFAULT 'PENDING' COMMENT '消息状态：PENDING/SENT/FAILED',
